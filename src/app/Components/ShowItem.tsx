...
const ShowItem: React.FC<ShowItemProps>= ({filteredItems,deleteItem}) =>{
  return (
    <>
      <div className='mt-6 space-y-4'>
                    {filteredItems.map(item => (
                        <div className='p-4 bg-white shadow rounded-lg border border-gray-200 flex flex-col' key={item.id}>
